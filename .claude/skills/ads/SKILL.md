---
name: ads
description: "Orchestrator/index for the AI Ads Strategist skill set. Lists every /ads sub-skill (strategy, audience, copy, hooks, creative, video, funnel, budget, testing, audit, landing, competitors, quick) and when to use each. Use when asked what ad skills are available or to run a full multi-part ad strategy."
---
